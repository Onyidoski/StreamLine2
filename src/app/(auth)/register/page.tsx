...
import { Eye, EyeOff, Check, Hexagon } from 'lucide-react'
    ...
    startTransition(async () => {
      ...
      if (res?.error) {
        ...
        toast.success("Account created successfully!", {
          description: "Please check your email for a confirmation link to log in.",
          duration: 6000,
          style: {
            background: '#00334E',
            color: '#fff',
    ...
    <div className="flex min-h-screen w-full font-sans">
      ...
      <div className="flex w-full flex-col justify-center bg-white px-8 py-12 lg:w-1/2 lg:px-20 xl:px-32">
        <div className="mb-12 flex items-center gap-2">
          {/* Logo placeholder - using a generic icon or text */}
        ...
        <div className="w-full">
          <h1 className="mb-8 text-3xl font-semibold text-gray-900">Create an account</h1>
              ...
              <FormField
                ...
                render={({ field }) => (
                  <FormItem>
                    ...
                    <FormControl>
                      <Input placeholder="Enter your name" className="bg-gray-50 border-gray-100 h-11" {...field} />
                    </FormControl>
                    <FormMessage />
                  </FormItem>
                )}
                  ...
                  <FormItem className="flex flex-row items-center space-x-3 space-y-0 p-1">
                    <FormControl>
                      <Checkbox
                        ...
                        className="data-[state=checked]:bg-[#00334E] border-gray-300"
                      />
                    </FormControl>
                    <div className="space-y-1 leading-none">
                      <FormLabel className="text-sm font-normal text-gray-600">
                        I agree to all the <span className="underline font-medium text-gray-700">Terms & Conditions</span>
                      </FormLabel>
                    </div>
                  </FormItem>
                )}
          ...
          <div className="mt-6 text-center text-sm text-gray-500">
            ...
            <Link href="/login" className="font-semibold text-[#00334E] hover:underline">
              Log in
            </Link>
          </div>
        </div>
